        ...
        private static void SeedDatabase(ApplicationDbContext context)
        {
            ...
            categories.Add(new Category()
            {
                ...
                Products = new List<Product>()
                {
                    new Product()
                    {
                        Name="Jackson Corey Beaulieu USA KV7 Winterstorm",
                        Description="Подпис 7-низ електрическа китара с форма на тяло King V от поредицата Artist Signature, която е проектирана според точните спецификации на Corey Beaulieu, водещ китарист на американската хеви метъл група Trivium. Тя се отличава с елхо тяло с въртящ се кленов плат и гланц полиестерно покритие и обвързано триколесно трислойно кленово гърло с графитна армировка, ръчно изтъркано масло и еднопластово черно свързване. Вратът е снабден с радиус (12 \"-16\") от абанос, със старчески перолоидни инкрустации на акули и 24 джубови фрези. Дължината на мащаба е 648 мм, ширината на гайката е 42.8 мм. Китарата е оборудвана с два покрити акумулатора Seymour Duncan Blackouts AHB 7 с трипътен превключвател и единичен контрол на главния звук с навит плосък бутон. Другите функции включват оригинален флойд-ъглови двойно заключващ 2-точков тремолонен мост, запечатани от Джаксън тунери, Floyd Rose заключващ гайка и низове NPS (.009, .011, .016, .024, .032, .042,. 052). Прозрачен дизайн с черен цвят.",
                        ImageUrl="https://cdn.shopify.com/s/files/1/1507/1680/products/0000_d4e3efc9-2b18-4a0a-a30d-febbb4d95c40_1024x1024.jpg?v=1633531720",
                        Price=8740
                    },
                    new Product()
                    {
